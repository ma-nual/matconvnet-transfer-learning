...
[net_bn, info_bn] = cnn_mnist1(...
  'expDir', 'data/mnist-bnorm1', 'batchNormalization', true);

[net_fc, info_fc] = cnn_mnist1(...
  'expDir', 'data/mnist-baseline1', 'batchNormalization', false);

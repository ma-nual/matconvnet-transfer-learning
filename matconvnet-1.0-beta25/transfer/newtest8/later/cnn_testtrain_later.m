...
mycifar_batch1_2_imdb = load('E:\store\artificial\matconvnet-1.0-beta25\matconvnet-1.0-beta25\transfer\newtest8\later\imdb.mat');

test_index_1 = find(mycifar_batch1_2_imdb.images.set==1);
test_index_2 = find(mycifar_batch1_2_imdb.images.set==2);
test_index = [test_index_1 test_index_2];

function [net, info] = cnn_train_orig(varargin)
...
switch opts.modelType
  case 'mnist'
    net = cnn_mnist_init_orig('networkType', opts.networkType) ;
  case 'cifar'
    net = cnn_cifar_init_orig('networkType', opts.networkType) ;
  otherwise
...
load ('E:\store\artificial\matconvnet-1.0-beta25\matconvnet-1.0-beta25\transfer\newtest8\original\train.mat')
load ('E:\store\artificial\matconvnet-1.0-beta25\matconvnet-1.0-beta25\transfer\newtest8\original\val.mat')
load ('E:\store\artificial\matconvnet-1.0-beta25\matconvnet-1.0-beta25\transfer\newtest8\original\test.mat')
load ('E:\store\artificial\matconvnet-1.0-beta25\matconvnet-1.0-beta25\transfer\newtest8\original\vis.mat')
